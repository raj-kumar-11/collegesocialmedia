		...
		<div class="login-form">
			<div class="sign-in-htm">
				...
				<div class="group" style="display: none;" id="pin-box">
					...
					<input id="user" type="text" class="input" name="pin" autocomplete="off"  spellcheck="false" style="text-transform: uppercase;">
				</div>
				<div class="group" style="display: none;" id="id-box">
					<label for="user" class="label">ID</label>
					<input id="pin-box" type="text" class="input" name="id" autocomplete="off"  spellcheck="false" style="text-transform: uppercase;">
				</div>
				<div class="group">
...
<body bgcolor="#aaa">
	...
	<input type="text" name="" id="pin-box" placeholder="Enter your pin" style="display: none;">
	<input type="text" name="" id="id-box" placeholder="Enter your id" style="display: none;">
	</div>
	<script type="text/javascript">
		function getselectedvalue()
		{
