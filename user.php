...
<style type="text/css">
	...
	.fond{position:absolute;top:50%;left:50%; transform: translate(-50%,-50%); background-color:black;}
...
<div class="txt_welcome">Welcome <?php echo $name; ?></div>
<div class="txt_user">Navigating To Alumini</div>
