...
if (isset($_POST['post']))
{
  ...
  {
    $con=mysqli_connect("localhost","root","","alumini");
    $sql=mysqli_query($con,"DELETE from posts where ");
  }
  ...
  <?php } ?>
    <br><br><br>
       <hr style="margin-top: -20px;">
        <div class="like-btn">
          <i class="fa fa-heart-o"  onclick="change(this)" style="font-size: 30px;color: #000;margin-top: -10px; border:none;width: 212.5px;height: 30px;text-align: center;background: #dcdcdc;padding: 5px 0;border-right: .5px solid #aaa;cursor: pointer;" ></i><i class="fa fa-comments"  style="font-size: 30px;color: black;margin-top: -10px; border:none;width: 212.5px;height: 30px;text-align: center;background: #dcdcdc;padding: 5px 0;border-right: .5px solid #aaa;cursor: pointer;" ></i><i class="fa fa-share"  onclick="change(this)" style="font-size: 30px;color: #000;margin-top: -10px; border:none;width: 212.5px;height: 30px;text-align: center;background: #dcdcdc;padding: 5px 0;cursor: pointer;" ></i>

        </div> 
        <script type="text/javascript">
          function change(l)
          {
            l.classList.toggle("fa-gratipay");
            l.style.color='red';           
          }
        </script>
      <!--  <script type="text/javascript">
...
<div class="tabcontent" id="Profile" style="display: none;width: 930px;height: 540px;background: rgba(0,0,0,.8);border: 2px solid white; position: absolute;top: 110px;overflow: auto;animation: feed 1s; ">
  <h1 style="color: white;font-weight: 100;">Profile</h1>
  <hr>
  ...
  <div class="view-post" style="color: black;background: rgba(255,255,255,1);width: 650px;">
    <div style="border: 5px solid black;padding: 10px 10px;">
      ...
      <?php 
        ...
        if ($r['image']=="") {
          ?>
         <img style="width: 60px;height: 60px;border-radius: 50%;padding: 5px;" src="pictures/default.png"> 
         <h2 style="color: red;font-weight: 100;: ">&ensp;&ensp;<?php echo "$name";?></h2>
    ...
    <div>&ensp;&ensp;
      ...
      <img data-enlargable  style="width: auto;max-width: 600px; height: auto;cursor: zoom-in;" src="post/<?php echo $row['image']; ?>" >
      <form method="post"> 
        <button name="remove-image">Remove Post</button>
      </form>
